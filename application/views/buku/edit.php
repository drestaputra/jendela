...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Edit Buku | <?php echo function_lib::get_config_value('website_name'); ?></title>
                                    ...
                                    <div class="panel-body">
                                                ...
                                                <select name="id_kategori_buku" style="width: 200px">                                                	
                                                	<?php foreach ($kategori_buku as $key => $value): ?>
                                                		<option <?php if ($buku['id_kategori_buku']==$value['id_kategori_buku']): ?>
                                                			selected
                                                		<?php endif ?> value="<?php echo $value['id_kategori_buku']; ?>"><?php echo $value['nama_kategori_buku']; ?></option>
                                                	<?php endforeach ?>
                                                </select>
                                            </div>                                            
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                    ...
                                                    <input type="text" name="judul_buku" value="<?php echo (trim($buku['judul_buku'])!="")?$buku['judul_buku']:""; ?>" class="form-control" placeholder="Judul buku" required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                    <textarea name="deskripsi_buku" id="editor"><?php echo (trim($buku['deskripsi_buku'])!="")?$buku['deskripsi_buku']:""; ?></textarea>
                                            </div>                                            
                                        </div>
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <img class="img-responsive img-thumbnail" src="<?php echo base_url('assets/image_buku/'.$buku['gambar_buku']); ?>">
                                            </div>
                                        </div>
                                    </div>
