					...
					<div class="panel-body">
						...
						<form method="post">
							...
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input name="pwd" type="password" class="form-control input-md" />
									<span class="input-group-addon">
										<span class="icon icon-lg">
							...
							<div class="row">								
								<div class="col-sm-12 text-right">
									<button type="submit" class="btn btn-brown-gradient btn-block hidden-xs"><b>Sign In</b></button>
									<button type="submit" class="btn btn-brown-gradient btn-block btn-lg visible-xs mt-lg"><b>Sign In</b></button>
								</div>
							</div>
