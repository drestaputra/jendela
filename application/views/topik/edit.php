...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Edit Topik | <?php echo function_lib::get_config_value('website_name'); ?></title>
				...
				<section role="main" class="content-body">
					...
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Edit Topik</h3>
                        </div>
                                    ...
                                    <div class="panel-body">
                                                    ...
                                                    <select class="form-control" name="id_blok" id="id_blok">
                                                        ...
                                                        if (count($blok)>0) {
                                                            foreach ($blok as $arrData) {
                                                                ?>
                                                                <option value="<?php echo $arrData['id_blok'] ?>"  <?php echo ($this->input->post('id_blok')!="")?(($this->input->post('id_blok')==$arrData['id_blok'])?'selected':''):(($topik['id_blok']==$arrData['id_blok'])?"selected":""); ?>><?php echo $arrData['nama_blok']; ?></option>
                                                                <?php
                                                            } 
                                                        }
                                                        ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                    ...
                                                    <input type="text" name="nama_topik" value="<?php echo ($this->input->post('nama_topik')!="")?$this->input->post('nama_topik'):$topik['nama_topik']; ?>" class="form-control" placeholder="Nama Topik.." required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                  <textarea id="ckeditor" name="skenario_topik"><?php echo ($this->input->post('skenario_topik')!="")?$this->input->post('skenario_topik'):$topik['skenario_topik']; ?></textarea>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-2 control-label">Learning Outcome <span class="required">*</span></label>
                                            <div class="col-sm-10">
                                                  <textarea id="ckeditor2" name="kunci_jawaban_topik"><?php echo ($this->input->post('kunci_jawaban_topik')!="")?$this->input->post('kunci_jawaban_topik'):$topik['kunci_jawaban_topik']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Vendor -->
        ...
        <script>
            ...
            var ckeditor2 = CKEDITOR.replace( 'ckeditor2', {
            extraPlugins: 'easyimage',
                cloudServices_tokenUrl: 'https://72749.cke-cs.com/token/dev/AgUhKJ0rTW7XycVH0iyT5KLwixVEYbJEX869S8oOSVrlHgj2H7dBL7hcEnHu',
                cloudServices_uploadUrl: 'https://72749.cke-cs.com/easyimage/upload/',
                height: 560,
