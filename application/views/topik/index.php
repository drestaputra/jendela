...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Topik | <?php echo function_lib::get_config_value('website_name'); ?></title>
								...
								<div class="panel-body">
									<form>
										<div class="form-group">
											...
											<input type="text" class="form-control input-sm" name="nama_topik" id="nama_topik">
										</div>
										<div class="form-group">
		...
		<script type="text/javascript">
                    ...
                    $("#gridview").flexigrid({
                        ...
                        colModel: [
                            ...
                            { display: 'Nama Topik', name: 'nama_topik', width: 200, sortable: true, align: 'left' },
                            { display: 'Skenario Topik', name: 'skenario_topik', width: 250, sortable: true, align: 'left' },
                            { display: 'Kunci Jawaban Topik', name: 'kunci_jawaban_topik', width: 200, sortable: true, align: 'left' },
                    ...
                    function tambah(){
                    	window.location='<?php echo base_url('topik/tambah'); ?>';
                    }
                    ...
                    function grid_reload() {
                        var nama_topik=$("#nama_topik").val();
                        
                        var url_service="?nama_topik="+nama_topik;
                        $("#gridview").flexOptions({url:'<?php echo base_url(); ?>topik/get_data'+url_service}).flexReload();
                    }
