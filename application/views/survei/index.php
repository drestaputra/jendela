...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Survei | <?php echo function_lib::get_config_value('website_name'); ?></title>
								...
								<div class="panel-body">
									<form>
										<div class="form-group">
											...
											<input type="text" class="form-control input-sm" name="nama_survei" id="nama_survei">
										</div>
                                        <div class="form-group">
                                            <label>Status</label>
                                            <select class="form-control" id="status_survei">
		...
		<script type="text/javascript">
                    ...
                    $("#gridview").flexigrid({
                        ...
                        colModel: [
                            ...
                            { display: 'Nama Survei', name: 'nama_survei', width: 200, sortable: true, align: 'left' },
                            { display: 'Gambar Survei', name: 'gambar_survei', width: 200, sortable: true, align: 'left' },
                    ...
                    function tambah(){
                    	window.location='<?php echo base_url('survei/tambah'); ?>';
                    }
                    ...
                    function grid_reload() {
                        var nama_survei=$("#nama_survei").val();
                        var status_survei=$("#status_survei").val();
                        
                        var url_service="?nama_survei="+nama_survei
                        +'&status_survei='+status_survei;                        
                        $("#gridview").flexOptions({url:'<?php echo base_url(); ?>survei/get_data'+url_service}).flexReload();
                    }
